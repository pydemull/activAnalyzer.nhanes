...
fig <-
  ...
  labs(
    ...
    caption = str_wrap("The boxplots have been manually built from the sampling weights-based estimates of the quantiles of the metrics. The lower and upper whiskers extend up to respectively the minimum and maximum of the distribution. No data is available for preschoolers.", width = 115),
    x = "", 
    y = ""
    ) +
  scale_fill_brewer(palette = palette) +
